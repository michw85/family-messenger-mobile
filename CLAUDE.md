...
- **Один класс/интерфейс — отдельный файл** (не группировать несколько в одном файле). DTO — всегда с суффиксом `*Dto`
- Комментарии — коротко и по делу, без разъяснений очевидного; минимум
